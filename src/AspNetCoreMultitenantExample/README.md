...
Run `dotnet run --project src/AspNetCoreMultitenantExample`, then compare <http://localhost:5000/api/tenant>, <http://localhost:5000/api/tenant?tenant=alpha>, and <http://localhost:5000/api/tenant?tenant=gamma>.
